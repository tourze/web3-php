...
use Tourze\Web3PHP\Methods\Eth\SubmitHashrate;
 ...
 * @internal
 */
#[CoversClass(SubmitHashrate::class)]
final class SubmitHashrateTest extends TestCase
{
    /**
     * 测试构造函数
     */
    ...
    {
        $method = new SubmitHashrate();

        $this->assertInstanceOf(SubmitHashrate::class, $method);
        $this->assertSame('eth__submit_hashrate', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__submit_hashrate', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__submit_hashrate', $payloadString);
