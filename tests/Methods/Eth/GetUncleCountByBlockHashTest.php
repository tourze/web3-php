...
use Tourze\Web3PHP\Methods\Eth\GetUncleCountByBlockHash;
...
/**
 * GetUncleCountByBlockHash 测试
 * @internal
 */
#[CoversClass(GetUncleCountByBlockHash::class)]
final class GetUncleCountByBlockHashTest extends TestCase
{
    /**
     * 测试构造函数
     */
    ...
    {
        $method = new GetUncleCountByBlockHash();

        $this->assertInstanceOf(GetUncleCountByBlockHash::class, $method);
        $this->assertSame('eth__get_uncle_count_by_block_hash', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__get_uncle_count_by_block_hash', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__get_uncle_count_by_block_hash', $payloadString);
