...
use Tourze\Web3PHP\Methods\Eth\GetUncleByBlockNumberAndIndex;
...
/**
 * GetUncleByBlockNumberAndIndex 测试
 * @internal
 */
#[CoversClass(GetUncleByBlockNumberAndIndex::class)]
final class GetUncleByBlockNumberAndIndexTest extends TestCase
{
    /**
     * 测试构造函数
     */
    ...
    {
        $method = new GetUncleByBlockNumberAndIndex();

        $this->assertInstanceOf(GetUncleByBlockNumberAndIndex::class, $method);
        $this->assertSame('eth__get_uncle_by_block_number_and_index', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__get_uncle_by_block_number_and_index', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__get_uncle_by_block_number_and_index', $payloadString);
