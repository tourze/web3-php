...
use Tourze\Web3PHP\Methods\Eth\ProtocolVersion;
...
final class ProtocolVersionTest extends TestCase
{
    ...
    {
        $method = new ProtocolVersion();

        $this->assertInstanceOf(ProtocolVersion::class, $method);
        $this->assertSame('eth__protocol_version', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__protocol_version', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__protocol_version', $payloadString);
