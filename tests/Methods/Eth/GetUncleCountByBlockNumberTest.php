...
use Tourze\Web3PHP\Methods\Eth\GetUncleCountByBlockNumber;
...
/**
 * GetUncleCountByBlockNumber 测试
 * @internal
 */
#[CoversClass(GetUncleCountByBlockNumber::class)]
final class GetUncleCountByBlockNumberTest extends TestCase
{
    /**
     * 测试构造函数
     */
    ...
    {
        $method = new GetUncleCountByBlockNumber();

        $this->assertInstanceOf(GetUncleCountByBlockNumber::class, $method);
        $this->assertSame('eth__get_uncle_count_by_block_number', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__get_uncle_count_by_block_number', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__get_uncle_count_by_block_number', $payloadString);
