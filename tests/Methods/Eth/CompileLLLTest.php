...
use Tourze\Web3PHP\Methods\Eth\CompileLLL;
 ...
 * @internal
 */
#[CoversClass(CompileLLL::class)]
final class CompileLLLTest extends TestCase
{
    /**
     * 测试构造函数
     */
    ...
    {
        $method = new CompileLLL();

        $this->assertInstanceOf(CompileLLL::class, $method);
        $this->assertSame('eth_compileLLL', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth_compileLLL', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth_compileLLL', $payloadString);
