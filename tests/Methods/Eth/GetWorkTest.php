...
use Tourze\Web3PHP\Methods\Eth\GetWork;
...
final class GetWorkTest extends TestCase
{
    ...
    public function testConstruct(): void
    {
        ...
        $this->assertInstanceOf(GetWork::class, $method);
        $this->assertSame('eth__get_work', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__get_work', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__get_work', $payloadString);
