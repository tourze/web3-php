...
use Tourze\Web3PHP\Methods\Eth\Mining;
 ...
 * @internal
 */
#[CoversClass(Mining::class)]
final class MiningTest extends TestCase
{
    /**
     * 测试构造函数
     */
    public function testConstruct(): void
    {
        ...
        $this->assertInstanceOf(Mining::class, $method);
        $this->assertSame('eth__mining', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__mining', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__mining', $payloadString);
