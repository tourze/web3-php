...
use Tourze\Web3PHP\Methods\Eth\SendRawTransaction;
...
/**
 * SendRawTransaction 测试
 * @internal
 */
#[CoversClass(SendRawTransaction::class)]
final class SendRawTransactionTest extends TestCase
{
    /**
     * 测试构造函数
     */
    ...
    {
        $method = new SendRawTransaction();

        $this->assertInstanceOf(SendRawTransaction::class, $method);
        $this->assertSame('eth__send_raw_transaction', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__send_raw_transaction', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__send_raw_transaction', $payloadString);
