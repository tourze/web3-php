...
use Tourze\Web3PHP\Methods\Eth\NewFilter;
...
final class NewFilterTest extends TestCase
{
    ...
    {
        $method = new NewFilter();

        $this->assertInstanceOf(NewFilter::class, $method);
        $this->assertSame('eth__new_filter', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__new_filter', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__new_filter', $payloadString);
