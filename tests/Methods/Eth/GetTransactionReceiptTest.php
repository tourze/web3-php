...
use Tourze\Web3PHP\Methods\Eth\GetTransactionReceipt;
 ...
 * @internal
 */
#[CoversClass(GetTransactionReceipt::class)]
final class GetTransactionReceiptTest extends TestCase
{
    /**
     * 测试构造函数
     */
    ...
    {
        $method = new GetTransactionReceipt();

        $this->assertInstanceOf(GetTransactionReceipt::class, $method);
        $this->assertSame('eth__get_transaction_receipt', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__get_transaction_receipt', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__get_transaction_receipt', $payloadString);
