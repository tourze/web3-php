...
use Tourze\Web3PHP\Methods\Eth\GetBalance;
...
final class GetBalanceTest extends TestCase
{
    ...
    {
        $method = new GetBalance();

        $this->assertInstanceOf(GetBalance::class, $method);
        $this->assertSame('eth_getBalance', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth_getBalance', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth_getBalance', $payloadString);
