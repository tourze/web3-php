...
use Tourze\Web3PHP\Methods\Eth\NewBlockFilter;
 ...
 * @internal
 */
#[CoversClass(NewBlockFilter::class)]
final class NewBlockFilterTest extends TestCase
{
    /**
     * 测试构造函数
     */
    ...
    {
        $method = new NewBlockFilter();

        $this->assertInstanceOf(NewBlockFilter::class, $method);
        $this->assertSame('eth__new_block_filter', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__new_block_filter', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__new_block_filter', $payloadString);
