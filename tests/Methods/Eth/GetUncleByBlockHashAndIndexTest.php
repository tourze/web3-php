...
use Tourze\Web3PHP\Methods\Eth\GetUncleByBlockHashAndIndex;
...
/**
 * GetUncleByBlockHashAndIndex 测试
 * @internal
 */
#[CoversClass(GetUncleByBlockHashAndIndex::class)]
final class GetUncleByBlockHashAndIndexTest extends TestCase
{
    /**
     * 测试构造函数
     */
    ...
    {
        $method = new GetUncleByBlockHashAndIndex();

        $this->assertInstanceOf(GetUncleByBlockHashAndIndex::class, $method);
        $this->assertSame('eth__get_uncle_by_block_hash_and_index', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__get_uncle_by_block_hash_and_index', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__get_uncle_by_block_hash_and_index', $payloadString);
