...
use Tourze\Web3PHP\Methods\Eth\GetLogs;
 ...
 * @internal
 */
#[CoversClass(GetLogs::class)]
final class GetLogsTest extends TestCase
{
    /**
     * 测试构造函数
     */
    public function testConstruct(): void
    {
        ...
        $this->assertInstanceOf(GetLogs::class, $method);
        $this->assertSame('eth__get_logs', (string) $method);
    }
    ...
    public function testDefaultProperties(): void
    {
        ...
        $this->assertSame([FilterValidator::class], $validators->getValue($method));
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__get_logs', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__get_logs', $payloadString);
