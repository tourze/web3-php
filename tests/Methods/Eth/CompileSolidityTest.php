...
use Tourze\Web3PHP\Methods\Eth\CompileSolidity;
 ...
 * @internal
 */
#[CoversClass(CompileSolidity::class)]
final class CompileSolidityTest extends TestCase
{
    /**
     * 测试构造函数
     */
    ...
    {
        $method = new CompileSolidity();

        $this->assertInstanceOf(CompileSolidity::class, $method);
        $this->assertSame('eth_compileSolidity', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth_compileSolidity', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth_compileSolidity', $payloadString);
