...
use Tourze\Web3PHP\Methods\Eth\GetTransactionByHash;
...
/**
 * GetTransactionByHash 测试
 * @internal
 */
#[CoversClass(GetTransactionByHash::class)]
final class GetTransactionByHashTest extends TestCase
{
    /**
     * 测试构造函数
     */
    ...
    {
        $method = new GetTransactionByHash();

        $this->assertInstanceOf(GetTransactionByHash::class, $method);
        $this->assertSame('eth__get_transaction_by_hash', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__get_transaction_by_hash', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__get_transaction_by_hash', $payloadString);
