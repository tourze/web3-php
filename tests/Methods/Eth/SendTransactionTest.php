...
use Tourze\Web3PHP\Methods\Eth\SendTransaction;
...
final class SendTransactionTest extends TestCase
{
    ...
    {
        $method = new SendTransaction();

        $this->assertInstanceOf(SendTransaction::class, $method);
        $this->assertSame('eth__send_transaction', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__send_transaction', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__send_transaction', $payloadString);
