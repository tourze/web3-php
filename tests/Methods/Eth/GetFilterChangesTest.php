...
use Tourze\Web3PHP\Methods\Eth\GetFilterChanges;
...
final class GetFilterChangesTest extends TestCase
{
    ...
    {
        $method = new GetFilterChanges();

        $this->assertInstanceOf(GetFilterChanges::class, $method);
        $this->assertSame('eth__get_filter_changes', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__get_filter_changes', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__get_filter_changes', $payloadString);
