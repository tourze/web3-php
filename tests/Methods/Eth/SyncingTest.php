...
use Tourze\Web3PHP\Methods\Eth\Syncing;
 ...
 * @internal
 */
#[CoversClass(Syncing::class)]
final class SyncingTest extends TestCase
{
    /**
     * 测试构造函数
     */
    public function testConstruct(): void
    {
        ...
        $this->assertInstanceOf(Syncing::class, $method);
        $this->assertSame('eth__syncing', (string) $method);
    }
    ...
    public function testToPayload(): void
    {
        ...
        $this->assertSame('eth__syncing', $payload['method']);
    ...
    public function testToPayloadString(): void
    {
        ...
        $this->assertStringContainsString('eth__syncing', $payloadString);
